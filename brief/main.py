...
def prepare_data(input_data_path):
    ...
    df=df.dropna()  # https://www.w3resource.com/pandas/dataframe/dataframe-dropna.php

    # encode the categorical variables
    df = pd.get_dummies(df) # https://pandas.pydata.org/docs/reference/api/pandas.get_dummies.html
...
if __name__ == '__main__':
    ...
    logging.warning(f'{X_test}')
    logging.error(f'{y_pred_test}')
